...
//   const toggleFilter = () => {
//     console.log("Filter button clicked, isFilterOpen:", !isFilterOpen); // Debugging log
...
//           />
//         </div>
//         <div className="relative w-full md:w-auto min-w-fit">
//           <button
//             onClick={toggleFilter}
//             className="w-full md:w-24 px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 transition duration-300 transform hover:scale-105 flex items-center justify-center gap-2 text-sm font-medium border border-blue-400 shadow-md"
//           >
//             <FontAwesomeIcon icon={faFilter} className="text-white text-base" fallback="F" />
//             Filters
//           </button>
//           {isFilterOpen && (
//             <div
//               ref={filterRef}
//               className="absolute top-full left-0 right-0 mt-4 w-full max-w-[720px] mx-auto bg-white border border-blue-200 rounded-lg shadow-xl p-4 z-10 transition-all duration-300 ease-in-out transform scale-95 opacity-0 animate-[fadeIn_0.3s_ease-in-out_forwards]"
//             >
...
//           className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 py-2 rounded-lg hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-600 transition duration-300 transform hover:scale-105 text-sm font-medium w-full md:w-auto border border-blue-400 shadow-md"
//         >
//           Search
//         </button>
//       </div>
